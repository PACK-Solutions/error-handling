 ...
 * This controller provides endpoints for retrieving reports based on user ID and report name.
 */
@RestController
...
public class ReportController {
    ...
    public Report getReport(
            @Parameter(description = "ID of the user requesting the report") @RequestParam String userId,
            @Parameter(description = "Name of the report to retrieve") @RequestParam String reportName) {
