...
/**
 * Exception thrown when a report for a specific user is not found.
 * This exception indicates that the requested report does not exist for the specified user.
 */
