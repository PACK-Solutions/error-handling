...
/**
 * Exception thrown when an invalid report name is provided to the report client.
 * This exception indicates that the requested report name does not exist or is not valid.
 */
