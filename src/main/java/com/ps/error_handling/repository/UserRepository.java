 ...
 * This is a simulated repository that randomly returns different outcomes for demonstration purposes.
 */
@Repository
public class UserRepository {
     ...
     * This is a simulated method that randomly:
     * - Throws a RuntimeException (10% chance)
     * - Returns an empty Optional (10% chance)
     * - Returns a User with the provided userId and a hardcoded email (80% chance)
     *
